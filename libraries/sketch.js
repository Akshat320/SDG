...
if(mousePressedOver(o3) && questionState === 3)
{
...
if(gameState === 5)
{
  ...
  if(gameState === 8)
  {
    ...
    textSize(40);
    fill("red");
    text("You Won the Game", 300, 380);
    textSize(30);
    fill("blue");
    text("Press Retry to go to Home Screen", 290, 420);  
    barrierGroup.destroyEach();
  }

  if(mousePressedOver(retry) && gameState === 8)
  {
...
if(mousePressedOver(retry1) && gameState === 6)
{
  gameState = 5;
  track.visible = true;
  car.visible = true;  
